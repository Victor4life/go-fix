  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Short delay to show the success message before navigation
        setTimeout(() => {
          navigate("/dashboard");
        }, 2000);
      } else {
    ...
    <section className="overflow-hidden relative">
      ...
      <div className="flex bg-gray-100 min-h-screen items-center justify-center px-4 py-12 sm:px-6 lg:px-20">
              ...
              <div>
                ...
                >
                  {loading ? (
                    ...
                    <>
                      <MdLogin className="mr-2 h-4 w-4" /> Sign in
                    </>
                  )}
                </button>
              </div>
        ...
        <div className="hidden lg:flex items-center justify-center w-1/2">
          <DotLottieReact
            src="https://lottie.host/f28520b2-1764-4aad-8a60-55ddee7182a2/iTaxMxe423.lottie"
            loop
            autoplay
            style={{
              width: "90%",
